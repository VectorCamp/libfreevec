...
int vec_strcmp(const uint8_t *src1pp, const uint8_t *src2pp) {
  ...
  STRCMP_UNTIL_SRC1_WORD_ALIGNED(src1, src2);
  ...
  STRCMP_UNTIL_SRC1_IS_ALTIVEC_ALIGNED(src1, src1l, src2, src2l, src2offset4);
  ...
  if (((uint32_t)(src2) % ALTIVECWORD_SIZE) == 0) {
    ...
    STRCMP_LOOP_SINGLE_ALTIVEC_WORD_ALIGNED(src1, src1l, src2, src2l, src2offset4);
    src2l = (uint32_t *)(src2 -src2offset4);
  } else {
    // src2 is not 16-byte aligned so we have to a little trick with Altivec.
    STRCMP_LOOP_SINGLE_ALTIVEC_WORD_UNALIGNED(src1, src1l, src2, src2l, src2offset4);
    src2l = (uint32_t *)(src2 -src2offset4);
  }
