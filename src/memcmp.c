...
int vec_memcmp(void *src1pp, const void *src2pp, size_t len) {
  ...
  if (len >= sizeof(uint32_t)) {
    ...
    MEMCMP_UNTIL_SRC1_IS_ALTIVEC_ALIGNED(src1, src1l, src2, src2l, len, src2offset4);
    ...
    if (len >= ALTIVECWORD_SIZE) {
      ...
      if (((uint32_t)(src2) % ALTIVECWORD_SIZE) == 0) {
        ...
        MEMCMP_LOOP_SINGLE_ALTIVEC_WORD_ALIGNED(src1, src1l, src2, src2l, src2offset4);
        src2l = (uint32_t *)(src2 -src2offset4);
      } else {
        // src2 is not 16-byte aligned so we have to a little trick with Altivec.
        MEMCMP_LOOP_SINGLE_ALTIVEC_WORD_UNALIGNED(src1, src1l, src2, src2l, src2offset4);
        src2l = (uint32_t *)(src2 -src2offset4);
      }
    }
    READ_PREFETCH_STOP;
    ...
    MEMCMP_REST_WORDS(src1, src1l, src2, src2l, len, src2offset4);
    src1 = (uint8_t *) src1l;
    src2 = (uint8_t *) src2l +src2offset4;
